...
for row in data['spots']:
 ...
 s.update({'source':source,'reviewed':data['reviewed'],'catalogNew':row.get('edition')==data.get('latestEdition'),'sky':'#c9dfed','sky2':'#8bbbd7','sea':'#2c789b','sea2':'#17486e','wind':'—','swell':'—','temp':'—','tide':'—','danger':0,'dangers':[], 'tip':''})
 spots.append(s)
