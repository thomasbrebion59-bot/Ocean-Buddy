...
(() => {
  ...
  const suggestions=[['Mon voyage','Aide-moi à préparer mon prochain voyage. Quelles informations te faut-il ?'],['Deux spots','Aide-moi à choisir entre deux spots du catalogue.'],['Les marées','Explique-moi simplement comment fonctionnent les marées.']];
  ...
  window.openChat=function(){
    ...
    if(first){addMsg('bot',endpoint?'Salut, moi c’est <b>Poulpy</b> ! On prépare un voyage, on compare des spots ou on discute d’un sujet qui t’intrigue ?':'Salut, moi c’est <b>Poulpy</b> ! Mon <b>guide intégré</b> peut déjà te faire découvrir les spots et les activités. Ma connexion à une IA n’est pas encore activée.');}
